...
public class RoleRestController {
	...
	public RolePojoResponse addPrivilegeToRole(@PathVariable("roleid") long roleId,
			@PathVariable("priviegeid") long priviegeId) {
		return roleFacade.addPrivilegeToRole(roleId, priviegeId);

	}

	@DeleteMapping("/{roleid}/{priviegeid}")
	public RolePojoResponse deletePrivilegeForRole(@PathVariable("roleid") long roleId,
			@PathVariable("priviegeid") long priviegeId) {
